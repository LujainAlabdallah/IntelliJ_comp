...
methodCall: THIS_KEYWORD PERIOD IDENTIFIER* PERIOD IDENTIFIER* LEFT_PAREN THIS_KEYWORD PERIOD arguments RIGHT_PAREN SEMICOLON
| THIS_KEYWORD PERIOD IDENTIFIER* ASSIGN any_type*;
